 ...
 */
#define USB_CFG_VENDOR_NAME     'w', 'w', 'w', '.', 'i', 's', 'e', '.', 'p', 'w', '.', 'e', 'd', 'u', '.', 'p','l','/','~','w','z','a','b','/','M','I','D','I'
...
#else
#	define USB_CFG_DEVICE_NAME     'V', '-', 'U', 'S', 'B', '-', 'M', 'I', 'D', 'I','-','P','E','D','A','L','+','S','W','I','T','C','H'
 ...
 */
#define USB_CFG_SERIAL_NUMBER   '0', '1', '0', '4' 
